        ...
        <div class="max-w-md mx-auto">
          <div class="divide-y divide-gray-200">
            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              ...
              <div class="mt-8">
                <!-- Upload Tab -->
                <div v-show="currentTab === 'upload'" class="space-y-6">
                ...
                <!-- Preview Tab -->
                <div v-show="currentTab === 'preview'" class="space-y-8">
                ...
                <!-- Video Tab -->
                <div v-show="currentTab === 'video'" class="space-y-8">
                  <div v-if="!videoGenerated" class="flex flex-col items-center space-y-4">
